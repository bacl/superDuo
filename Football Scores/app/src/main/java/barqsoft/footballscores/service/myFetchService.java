...
public class MyFetchService extends IntentService {
    ...
    public static String ACTION_DATA_UPDATED = "barqsoft.footballscores.ACTION_DATA_UPDATED";
    ...
    private void processJSONdata(String JSONdata, Context mContext, boolean isReal) {
        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                ...
                mLeague = match_data.getJSONObject(LINKS).getJSONObject(SOCCER_SEASON).
                        getString("href");

                mLeague = mLeague.replace(SEASON_LINK, "");
                if (mLeague.equals(PREMIER_LEGAUE) ||
                        mLeague.equals(SERIE_A) ||
                        mLeague.equals(CHAMPIONS_LEAGUE) ||
                        mLeague.equals(BUNDESLIGA) ||
                    ...
                    match_values.put(DatabaseContract.scores_table.LEAGUE_COL, mLeague);
